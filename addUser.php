<?php 
	...
	function uploadRegisterInformation($error)
	{
		if(!$error)
		{
			...
			$addQuery = "INSERT INTO users (firstname, lastname, dob, city, provstate, country, nickname, email, pswrd, phonenumber, companyname)
			VALUES (:firstname, :lastname, :dob, :city, :provstate, :country, :nickname, :email, :password, :phonenumber, :company)";
			...
			$addStatement->bindValue(':phonenumber', $phonenumber);
